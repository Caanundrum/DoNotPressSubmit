...
export function ScenePlayerView(p: ScenePlayerViewProps) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-[5] flex max-w-full items-start justify-between gap-3 px-3 pt-3 pr-36 sm:px-4 sm:pt-4 sm:pr-40">
