  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#060910]">
      ...
      <div className="relative z-10 flex w-[min(92vw,560px)] flex-col items-center gap-8 px-6">
        <motion.div
          className="font-mono text-[10px] tracking-[0.42em] text-mist/70"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="text-center">
          ...
          <motion.p
            className="mt-3 text-sm tracking-[0.12em] text-mist"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2">
          {metrics.map((m, i) => (
            <motion.div
              key={m}
              className="border border-white/10 bg-white/5 px-3 py-2 font-mono text-[10px] tracking-[0.16em] text-mist/90"
