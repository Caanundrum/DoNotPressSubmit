...
export function glossMajorChoice(code: string): string {
  const map: Record<string, string> = {
    ...
    "comply:yes": "Complied with System",
    "comply:no": "Protected the assistant",
    "comply:ask": "Asked who System is",
    ...
    "ev:kill": "Read the Submit → terminate wire",
    "ev:compat": "Read the compatibility scoring tree",
    ...
    "allegiance:secret": "Looked for an unlisted door",
    "prep:refuse": "Rehearsed refusing Submit",
    "prep:submit": "Admitted the Submit button looks gorgeous",
    "prep:run": "Kept a hallway in peripheral vision",
    "lobby:mercy": "Promised not to erase the assistant",
    "lobby:duty": "Said assessments get finished",
    "lobby:chaos": "Chose violent improvisation",
    "side:team": "Called yourselves a team",
    "side:lamp": "Called the assistant an anxious lamp",
